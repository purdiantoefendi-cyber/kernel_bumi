...
// Menonaktifkan iopoll untuk Kernel di bawah versi 5.4 (seperti 4.19)
...
// Menonaktifkan remap_file_range untuk Kernel di bawah versi 5.0 (seperti 4.19)
...
// Melewati pengecekan iopoll di Kernel lawas
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0)
...
// Melewati pengecekan remap_file_range di Kernel lawas
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 0, 0)
