...
static int thermal_mitigation_dcp[] = {
        ...
        2500000,2500000,2500000,2500000,2500000,                   /*亮屏Normal*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000,                /*亮屏game*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000,                   /*亮屏Vedio*/
        2500000,2500000,2500000,2500000,2500000,2500000,       
        2500000,2500000,2500000,2500000,                        /*亮屏class0*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000,                 /*亮屏camera*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000                     /*灭屏normal*/
        };
...
static int thermal_mitigation_dcp_india[] = {
        ...
        2500000,2500000,2500000,2500000,2500000,                   /*亮屏Vedio*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000,                 /*亮屏class0*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000,                  /*亮屏camera*/
        2500000,2500000,2500000,2500000,2500000,
        2500000,2500000,2500000,2500000,2500000                     /*灭屏normal*/
...
static bool mtk_is_charger_on(struct charger_manager *info)
{
         ...
         * ==================================================== */
        // Jika kabel yang dicolok terbaca sebagai USB PC atau Powerbank standar
        if (chr_type == STANDARD_HOST || chr_type == CHARGING_HOST) {
                // Paksa identitasnya menjadi Charger Dinding/Adaptor AC!
