...
static int sgm4151x_set_ichrg_curr(struct charger_device *chg_dev, unsigned int chrg_curr)
{
        ...
        /* ====================================================
         * HACK FAST CHARGING: MAXIMIZE BATTERY CURRENT (2.5A)
         * ==================================================== */
        // Selaraskan dorongan ke baterai dengan arus masuk (2.5A)
        // selama suhu baterai masih dalam batas aman (minta >1.5A)
        if (chrg_curr >= 1500000) {
                chrg_curr = 2500000;
        }
        /* ==================================================== */
...
static int sgm4151x_set_input_curr_lim(struct charger_device *chg_dev, unsigned int iindpm)
{
        ...
        /* ====================================================
         * HACK FAST CHARGING: MAXIMIZE INPUT CURRENT (2.5A)
         * ==================================================== */
        // Jika sistem meminta arus normal/tinggi (di atas 1.5A)
        // Kita paksa buka keran input hingga 2.5 Ampere! (2500000 uA)
        // Jika sistem minta arus kecil karena panas, biarkan aman.
        if (iindpm >= 1500000) {
                iindpm = 2500000; 
        }
        /* ==================================================== */
