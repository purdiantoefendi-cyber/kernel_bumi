...
void fg_bat_temp_int_sw_check(void)
{
        ...
        /* ====================================================
         * HACK EXTREME THERMAL 1: BYPASS ALARM PANAS OS
         * ==================================================== */
        if (tmp >= 40 && tmp <= 48) {
                tmp = 38; 
        }
...
void fg_bat_temp_int_internal(void)
{
        ...
        /* ====================================================
         * HACK EXTREME THERMAL 2: ILUSI GLOBAL ANDROID UI
         * ==================================================== */
        // Memastikan UI OS, Kecerahan Layar, dan FPS Game tidak disunat!
        if (tmp >= 40 && tmp <= 48) {
                tmp = 38; 
        }
        /* ==================================================== */
        ...
        case FG_DAEMON_CMD_GET_TEMPERTURE:        /* fix me */
                {
                        ...
                        /* ====================================================
                         * HACK EXTREME THERMAL 3: BYPASS FUEL GAUGE DAEMON
                         * ==================================================== */
                        if (temperture >= 40 && temperture <= 48) {
                                temperture = 38;
                        }
                        /* ==================================================== */
